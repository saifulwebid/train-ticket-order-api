...
class Booking(models.Model):
    ...
    id_layanan_kereta = models.ForeignKey('LayananKereta', models.DO_NOTHING, db_column='id_layanan_kereta')
...
class LayananKereta(models.Model):
    ...
    id_kereta = models.ForeignKey(Kereta, models.DO_NOTHING, db_column='id_kereta')
...
class Pembayaran(models.Model):
    ...
    kode_booking = models.ForeignKey(Booking, models.DO_NOTHING, db_column='kode_booking')
    id_tipe_pembayaran = models.ForeignKey('TipePembayaran', models.DO_NOTHING, db_column='id_tipe_pembayaran')
...
class Pemesan(models.Model):
    kode_booking = models.ForeignKey(Booking, models.DO_NOTHING, db_column='kode_booking', primary_key=True)
...
class RangkaianPerjalanan(models.Model):
    ...
    id_layanan_kereta = models.ForeignKey(LayananKereta, models.DO_NOTHING, db_column='id_layanan_kereta')
    stasiun_kedatangan = models.ForeignKey('Stasiun', models.DO_NOTHING, db_column='stasiun_kedatangan')
    stasiun_keberangkatan = models.ForeignKey('Stasiun', models.DO_NOTHING, db_column='stasiun_keberangkatan')
    ...
    class Meta:
        ...
        unique_together = (('id_layanan_kereta', 'stasiun_kedatangan', 'stasiun_keberangkatan'),)
