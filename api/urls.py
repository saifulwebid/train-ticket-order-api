...
urlpatterns = [
    ...
    url(
        r'^perjalanan/(?P<tahun>\d+)/(?P<bulan>\d+)/(?P<hari>\d+)/(?P<asal_id>.+)/(?P<tujuan_id>.+)/(?P<jml_penumpang>\d+)/$',
        views.RangkaianPerjalananList.as_view()),
    ...
    url(r'^carapembayaran/$', views.CaraBayarList.as_view()),
]
