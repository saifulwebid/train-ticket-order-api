...
urlpatterns = [
    ...
    url(r'^booking/(?P<pk>[0-9]+)/penumpang/$',
        views.PenumpangDetail.as_view()),
    url(r'^booking/(?P<pk>[0-9]+)/carabayar/$',
        views.CaraBayarDariBooking.as_view()),
    ...
    url(r'^cek-kode-booking/(?P<kode_bayar>[0-9]+)/$',
        views.CekKodeBooking.as_view())
]
